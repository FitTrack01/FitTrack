...
function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  ...
  <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C42.02,35.846,44,30.138,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
  );
}
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to continue to FitTrack.</CardDescription>
          </CardHeader>
          <CardContent>
